...
<!--[if gte IE 9]><html  <?php language_attributes(); ?> class="lt-ie9"><![endif]-->
			...
			<header class="header" role="banner" itemscope itemtype="http://schema.org/WPHeader">
				...
				<div id="inner-header" class="cf">
					...
					<?php wp_nav_menu(array(
						 ...
						 'menu_class' => 'nav socket-nav cf',               // adding custom nav class
					...
					<a href="#" class="menu-button nav-icons">Menu</a>
					<a href="<?php echo esc_url( home_url('/?s=') ); ?>" class="search-button nav-icons">Search</a>
