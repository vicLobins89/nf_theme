...
function bones_scripts_and_styles() {
  ...
  if (!is_admin()) {
    ...
    if ( is_singular() AND comments_open() AND (get_option('thread_comments') == 1)) {
		...
		wp_register_script( 'zoom-js', get_stylesheet_directory_uri() . '/library/js/elevatezoom-master/jquery.elevateZoom-3.0.8.min.js', array( 'jquery' ), '', true );
		wp_register_script( 'bones-js', get_stylesheet_directory_uri() . '/library/js/scripts.js', array( 'jquery' ), '', true );
		wp_register_script( 'google-maps', 'https://maps.googleapis.com/maps/api/js?key=AIzaSyDuGc9ls0SFL2r-Tr5XI0KYu5xFHBAZ1b8', array( 'jquery' ), '', true );
